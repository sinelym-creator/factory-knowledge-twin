...
| `.workspace/drafts/` | 초안(SSOT 아님) — `decision-004-release-gate-draft.md`(§35.7 최종 관문 상신문 · 20대 초안 14:32 → **21대 수치 확정·폐하 상신 09-02 15:5x**(#386 반영 · D-21 동반) · 승인 원문·id 기입 뒤 `docs/decisions/004` 승격) · `baseline-v0.3-scope-cut-draft.md`(축소 안 · 폐하 A~G 승인 09-01 · **baseline 본문 반영 완료 09-02 #356** · 재가 칸 ☑ · 이력 보존) | 초안 추가·baseline 반영 시 |
