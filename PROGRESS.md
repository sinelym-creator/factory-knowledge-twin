...
| Phase | 티켓 | 담당 |
|---|---|---|
| 6 | 🔴 **T6-2 소유자 스위치 live 합성(P0 · 원장 48→49)** — 구현 #423·runbook #424/#426·low #428 · **독립 검증 PASS #432**(7/8축 · ⑤ 13.8s 병기) · D-23 수리 3층 착지(#435·#436) · 배포 ai-api 교체 2회차 **`ad788d3`**(09:19 · 외부 3경로 PASS 09:21) · ③ iOS 진행 표시 #435 + e2e 그물 #439 · **남음 = D-23 화면 재확인 B(리바이2 · 401 무대 · 구독 0) → ✅ → 승격 4회차** | 센쿠2 + 리바이2 + 오케 |
| 6 | 🔴 **T6-3 체감 속도(P0 · 원장 49→50)** — 계약 v0.1.13 #429 · 본 발주 09:27 · **PR 1 #438 게이트웨이 NDJSON 스트리밍 = PASS(병합 = 승격 뒤)** · PR 2 wip `c506966`(선표시 +2.1s · 남은 것 5) · 리바이2 스키마+케이스 PR(C) 선행 · 상한 09-04 | 센쿠2 + 리바이2 + 오케 |
| 6 | 🔴 **T6-4 디자인 전면(애플 감성 + 모션 + 반응형·호환 · P0 · 원장 50→51 · 폐하 08:14~08:19)** — 규격서 `docs/design/t6-4-apple-design-spec.md` ①~⑧(#433/#434) · 발주문 선작성 · **발주 = 승격 4회차 뒤** · PR 3분할 · 승격 5회차 · 상한 09-04 | 센쿠2 + 리바이2 + 오케 |
| 6 | ✅ **T6-1 Live 진단 synthesis(P0 · 폐하 결정 3)** — 구현 #407·#409(센쿠2 31대) · 계약 v0.1.11 #403 + 스키마 #406 · **독립 검증 PASS #410**(리바이2 27대 · ①결속 0위반(스텁 200 형상 · 가드 도달 각 1 · 대조군 2/2 rationale) ②갈림 3/3(off·미도달 8799·CLI 부재 8788 503 실재) ③env·키 0(코드 축 · 8787 로그 면 = 센쿠2 소유 미측) ④fixture 심사 PASS(32 이벤트 · 285 문자열 · sha 일치) ⑤화면 채택 2/2·거부 0/2+사유 렌더 + e2e 130/3/3(조건 갈림 online=true · 못 잼 2 · D-22 1) ⑥지연 미충족 · 자수 2) · 🔴 지연 Target 10s/Actual 합성 step 18.4~19.1s(벽시계 run 21.5~26.7s) 미달 = baseline §33 회부(폐하) · 승격 3회차 #411 | 센쿠2 + 오케 + 리바이2 · **⑦ #418 충족 → 7축 전건(09-03)** |
