...
| Phase | 티켓 | 담당 |
|---|---|---|
| 6 | **D-004 집행(폐하 「전건 권장안 승인」 16:59)** — ✅ `docs/decisions/004` 승격 · 원장 43/47(T5-5 완결 · T5-1~T5-4 이관) · 진행 = 센쿠2 ⓐ PR #391 판정·병합 → 리바이2 Q-73 2차 PR → verdict §4·§35.7 관문 행 1줄(리바이2 소조각) → 21대 마감(회고·재개점) | 오케 + 센쿠2(#391) + 리바이2(Q-73·verdict) |
...
| 🔶 **D-21 ⓒ 폴링 전환(1순위)** | 공개 셸 Live WS 미개통(Vercel 경유 구간 · 직결 정상) → WS 시도 대신 주기 GET 폴링(셸 1파일 · 새 서버 코드 0 · 유실 0) + 「실시간」 주장 문면(§17.2·§21②·Gate 6)·그물 4본 재정렬 · ⓑ 직결은 기각 | D-004 · 원장 D-21 · #388 |
...
| 🔶 **Q-73 networkidle** | 판정 = Q-73 2차 뒤 기재(그물 대기 조건 개정 여부) | 원장 Q-73 · #390 |
