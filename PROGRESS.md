...
| Phase | 티켓 | 담당 |
|---|---|---|
| 7 | 🔴 **T7-1 처방 착지 + 독립 재측 완결 20:28 — 4축 중 3 초록 · 1 빨강** — 재가분 전건 구현(원칙 ①②③④ + 시안 **ⓐ** + 레이아웃 **ⓒ** · PR **#489** `ee3daab` · 커밋 6본 · `apps/**` 만) · 검증 PR **#490** 병합 · ✅ **44px 성립**(coarse 미달 **20→6~10** · 축이 **폭 → pointer** 로 이동 · 🔴 `fine` 미달은 **설계 의도**) · ✅ **overview 정렬 Δ 0**(안내 카드 **열림·닫힘 둘 다**) · ✅ **회귀 3종 무변**(e2e **134/4/4** · 빨강이 **같은 4건** · 5번째 없음) · 🔴 **D-33 가로 넘침 회귀**(`(pointer:coarse)` 에서만 · **60/60칸** · 규격 §8 위반 · **수리 중**) · 판정문 `docs/design/t7-1-accessibility-verdict.md` · 회부 = **D-30·D-31 폐하 결정** · D-32·D-34·D-35·D-36 | 센쿠2 36대 · 리바이2 35대 · 오케 판정 |
