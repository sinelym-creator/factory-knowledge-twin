...
| Phase | 티켓 | 담당 |
|---|---|---|
| 6 | ✅ **T6-2 소유자 스위치 live 합성(P0 · 원장 48→49)** — 구현 #423·runbook #424/#426·low #428 · **독립 검증 PASS #432**(7/8축 · ⑤ 13.8s 병기) · D-23 수리 3층 착지(#435·#436) · 배포 ai-api 교체 2회차 **`ad788d3`**(09:19 · 외부 3경로 PASS 09:21) · ③ iOS 진행 표시 #435 + e2e 그물 #439 · **남음 = D-23 화면 재확인 B(리바이2 · 401 무대 · 구독 0) → ✅ → 승격 4회차** | 센쿠2 + 리바이2 + 오케 · ✅ **완결(원장 45)** |
| 6 | ✅ **T6-3 체감 속도(P0 · 원장 49→50)** — 계약 v0.1.13 #429 · 본 발주 09:27 · **PR 1 #438 게이트웨이 NDJSON 스트리밍 = PASS(병합 = 승격 뒤)** · PR 2 wip `c506966`(선표시 +2.1s · 남은 것 5) · 리바이2 스키마+케이스 PR(C) 선행 · 상한 09-04 | 센쿠2 + 리바이2 + 오케 · ✅ **완결 15:54(원장 46)** = PR 1 #438 + PR 2 #443 + fixture #453(32→38) · 리바이2 무회귀 판정(전용 빨강 0 · flaky 분리) |
| 6 | 🔴 **T6-4 디자인 전면(애플 감성 + 모션 + 반응형·호환 · P0 · 원장 50→51 · 폐하 08:14~08:19)** — 규격서 `docs/design/t6-4-apple-design-spec.md` ①~⑧(#433/#434) · 발주문 선작성 · **발주 = 승격 4회차 뒤** · PR 3분할 · 승격 5회차 · 상한 09-04 | 센쿠2 + 리바이2 + 오케 · 🔴 **재수립 14:24(폐하) → 재설계 PR #457 · 폐하 재가 15:25 + 조건 2 반영 15:31** · 다크 기본 전환 · 레일 260 라벨형 · 테두리 0 · 차트 = 밴드+중앙선 · 5화면 전개 · 검증 = 리바이2 ⓔ 6축(상한 16:25) |
| 6 | 🔴 **T6-5 게임식 가이드 투어(P0 · 원장 51→52 · 폐하 13:45)** — 규격 #450 · 구현 = 스자쿠 직접 · **PR #457 `30b1062`**(9스텝 · REPLAY 전용 · OFF 렌더 0) · 완주 드릴 PASS(초대 1 · 스텝 1~9 · 클릭 강제 · 재개 · Esc · console error 0) · 검증 = 리바이2 ⓔ 확대분(OFF 무영향·DOM diff·키보드·reduced·390·문구 경계) | 스자쿠 27대 |
