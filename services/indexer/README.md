...
| wireframes 앵커 | 그 문서의 실측 최대 chunk 수 | 판정 |
|---|---:|---|
| `DOC-MAN-0021#014` | 11 (`section*/400`) | 도달 불가 |
| `DOC-MAN-0022#009` | 7 | 도달 불가 |
| `DOC-SOP-0014@r2#007` | 4 | 도달 불가 |
| `DOC-MRP-0087#003` | 1 (문서 전체가 400 token 미만) | 도달 불가 |

분량을 앵커에 역산하지 않는다(전임 인계 ⑶). **정책을 동결한 뒤 실값을 보고**하고,
`wireframes.md` 갱신은 오케스트레이터 scope다(티켓 게이트 ⑤).

권고 정책(`section_sentence/512`)에서의 기대 인용 실좌표는 이렇다 — 동결 시 그대로 쓴다:

| 인용 | 실좌표 |
|---|---|
| `DOC-SOP-0014@r2` 진단 기준 3문항(Q1~Q3) | `#002` |
| `DOC-MAN-0021@r1` 「베어링 마모는 초기에 RMS가」·「진동 RMS가」 | `#005` |
| `DOC-MRP-0087@r1` 「베어링 교체」·「2025-02-11」 | `#001` |
| `DOC-SAF-0029@r3` LOTO · `DOC-SAF-0030@r3` PPE | 각 `#001` |
