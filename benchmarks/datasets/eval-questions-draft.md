...
> **◇ 의존**: `MR-2025-0087`이 특정 WorkOrder·Incident에 연결돼 있어야 한다(§5 D-8).
...
| D-8 | 정비이력 ↔ WorkOrder ↔ Incident 연결 | `Q-MULTIHOP-002` | ◻ **부분** — `MR-2025-0087`·`WO-2026-0113`·`INC-2026-014` 실재 · **상호 연결 미명시** | **존치**(Phase 1) |
