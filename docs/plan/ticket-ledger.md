...
| T2-4 | structured audit event + replay fixture 녹화(seq 기준) | 구현 | 조사 실행 스트림 기록 — Phase 3 replay engine·Phase 4 fallback의 원천 | T2-3 ✅ | 🔶 구현 착지 08-30(PR#124 — fixture 32건 JSONL 무가공 · 왕복 12/12 «치환 2필드 제외 전건 일치» · 🔴 의존 없이 replay 200 실증(Phase 4 fallback 축) · 공개 경계 심사 5축+대조군 · 판정 J-A~J-I 성문) · **독립 검증 발주**(리바이2 8대 — R-07 그물 갱신·ssot_write 대상 선택 정정 인계 포함) |
