...
## 원장 (진행률 = ✅ 29 / 총 31 — 🔴 **T2-4 완결 08-30 09:17**(재검 PASS · PR#129) · T2-3 완결 04:30(PR#121) · T2-2 완결 03:17(PR#114) · T2-1 완결 01:41(PR#108) · Phase 2 진입 재가 00:04 · Phase 1 완결 08-29 19:05 · 분모 이력: 🔴 25→31 T2-1~T2-6 등재 · 24→25 T1-10 등재 · 15→24 Phase 1 분해)
...
| T2-5 | WO 초안 생성·승인 API — CRUD·approve/reject·🔴 안전 조치 서버측 삭제 불가(R12 REQUIRES 강제) + 승인 이력·`approval_state` 전이 규칙(Q-11 종결분) | 구현 | 화면 ④의 「지울 수 없는 항목」을 UI가 아니라 서버가 강제 | T2-3 ✅ | 🔶 구현 «병합 착지» 08-30 11:44(PR#134 · 9파일 — approvals 원장·4라우트·R12 화이트리스트+형제 6종+7번째(approve 본문 = 편집 경로 → 422)·검증 도구 2종 · 게이트 1 판정 = 계약 v0.1.4·v0.1.5·Q-11 종결) · **독립 검증 «착수» 08-30 14:53**(리바이2 10대 — 대상 b138610 고정 · 그물 = 9대 성문분 lane/levi2-t2-5-verify 8d00893 · 4단계 순서) |
