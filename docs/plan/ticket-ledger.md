...
## 원장 (진행률 = ✅ 18 / 총 25 — 🔴 분모 24→25: T1-10 등재 08-28 16:24 — 🔴 분모 15→24: Phase 1 분해 +9 등재 08-28 15:53 · 분모 정비이지 후퇴 아님)
...
| ID | 티켓 | 담당 | AC 요지 | 상태 |
|---|---|---|---|---|
| T1-1 | PG 스키마·마이그레이션(온톨로지 §4 분담표→DDL·pgvector) | 구현 | 스펙 1:1 대조·재실행 가능 | ✅ PASS(독립 검증 — 대조표 전건 일치·멱등 · senku2 · PR#30 · 검증 levi2 · PR#35) — 후속 소커밋: G-4a·G-1 CHECK 3줄 + db README C·D절 정정(센쿠2 예약) |
