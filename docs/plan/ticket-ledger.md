...
| Q-40 | `replay_fixture_drill` F-11 실패 — fixture «부재» 시나리오가 501 기대인데 **200**(워크트리·메인 트리 양쪽 재현 · T3-3 서버 변경 0이라 귀속 별건). 원인 특정 필요: 데이터 상태(어느 실행이 fixture를 만들었나) vs 회귀 | levi2 11대 T3-3 검증 R-6(08-30 · E1) | 🔴 **triage 발주 08-31 09:35** 리바이2 12대 · `lane/levi2-q40-triage` @ 9949a68(데이터 상태 vs 회귀 — 판정 회부 1회 · Q-41 동반) |
