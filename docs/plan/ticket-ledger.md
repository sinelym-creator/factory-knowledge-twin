...
## 원장 (진행률 = ✅ 10 / 총 15 — 🔴 분모 13→15: T0-10·T1-0 등재 08-28 15:42 · 분모 정비이지 후퇴 아님)
...
| T0-5 | `packages/contracts/` API·event contract v0.1 | 오케 | REST·WebSocket·replay event 스키마 — 동결 대기 | F-4 잔여 2필드+stale 수정 · 최종 확인 대기(suzaku · PR#14) |
...
| T0-9 | Phase 0 산출물 독립 검증(AC 대조·정합) | 검증 | 전 산출물 PASS/FAIL 판정 + 지적사항 | v1.2 재검증 완료(levi2 · PR#13) · T0-5 최종 확인만 잔여 |
