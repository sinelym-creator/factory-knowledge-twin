...
| 4 | Live AI 연결(Tunnel·streaming·fallback) | S7 | ⏳ 진입 재가 08-31 09:57 — 4티켓(T4-1~T4-4 · 분모 37→46) · P3 잔여와 «병행» · 결정 ①~⑤ 승인(Tunnel = Funnel→Named · Vercel = 착수 시 확인 1회 · 동등 보호 · Cloud DB 미사용 · `.github/infra` = 구현 scope) |
| 5 | 평가·보안·운영(Gate 1~8 전건) | 배포 후 | 등재 — §3 별도 재가 08-31 09:57 · 5티켓(T5-1~T5-5) · 착수 = P4 흐름 보며(T5-1 즉시 병행 가능) |
